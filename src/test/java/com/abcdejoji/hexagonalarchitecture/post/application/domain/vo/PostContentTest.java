...
class PostContentTest {
    ...
    @Test
    @DisplayName("내용에 null이 들어오면 AssertionError가 발생한다")
    ...
    @Test
    @DisplayName("내용에 빈 값이 들어오면 AssertionError가 발생한다")
    ...
    @Test
    @DisplayName("내용에 널 스트링이 들어오면 AssertionError가 발생한다")
    ...
    @Test
    @DisplayName("내용이 500자가 넘으면 AssertionError가 발생한다")
